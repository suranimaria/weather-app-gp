...
// Component for displaying weather warnings in current location 
export default class Warnings extends Component {
    ...
    // Fetches extreme weather warnings data from a local JSON file
    // (future improvement: replace with paid API)
    fetchWarnings = () => {
